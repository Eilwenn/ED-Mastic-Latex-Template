...
Maintainers: Gaëlle Jouis (gaelle.jouis@pole-emploi.fr) 


Previous upstream git repository (2019-2020): 
- https://gitlab.inria.fr/proman/mathstic-thesis-template
-  https://gitlab.inria.fr/ed-mathstic/latex-template (fork) 
